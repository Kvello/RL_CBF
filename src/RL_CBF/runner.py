...
from aerial_gym.config.controller_config.lee_controller_config import control as control_config
from aerial_gym.robots.base_multirotor import BaseMultirotor
from controllers.simplified_attitude_control import LeeAttitudeController as simplified_attitude_control
from task.CBF_navigation_task import CBFNavigationTask
from config.robot_config.CBF_quad_config import CBFQuadCfg
from config.task_config.CBF_navigation_task_config import task_config as CBFNavigationTask_config


controller_registry.register_controller(
    "simplified_attitude_control", simplified_attitude_control,
    control_config
)

task_registry.register_task(
    "CBF_navigation_task", CBFNavigationTask,
    CBFNavigationTask_config
)

robot_registry.register(
    "CBF_quadrotor", BaseMultirotor, CBFQuadCfg
)
...
env_configurations.register(
    "CBF_navigation_task",
    {
        "env_creator": lambda **kwargs: task_registry.make_task("CBF_navigation_task", **kwargs),
