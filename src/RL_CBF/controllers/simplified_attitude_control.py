...
class LeeAttitudeController(BaseLeeController):
    ...
    def update(self, command_actions):
        ...
        :param command_actions: tensor of shape (num_envs, 3) with desired thrust, roll and pitch command in vehicle frame
        ...
        self.euler_angle_rates[:, 2] = 0.0 # Zero yaw rate for simplicity
